...
In this article you will find detailed instructions on [how to try out and test the current alpha version of Umbraco .Net Core](umbraconetcoreupdates.md#net-core-alpha). You will also find a list of relevant links to official as well as unofficial resources on the upcoming release.
...
Now you can continue in the same way as if you were using the [Alpha version](umbraconetcoreupdates.md#steps-to-create-an-umbraco-solution-using-the-dotnet-new-template)
